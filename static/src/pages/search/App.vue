...
.weibo-frame {
  ...
  .weibo-right-col {
    position: absolute;
    top: 141px;//same with weibo-frame's padding top;
    right: 0;
    width: 300px;
    >div{
      width: 300px;
  ...
  >.search-box {
    margin-bottom: 30px;
    .search_logo {
      background: url("http://img.t.sinajs.cn/t4/appstyle/searchV45/images_v6/common/search_logo.png?id=201409221153") no-repeat;
      width: 114px;
      height: 34px;
      float: left;
      margin-right: 34px;
    ...
    .search_head_formbox .formbox_tab {
      margin-bottom: 14px;
