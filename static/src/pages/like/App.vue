<template>
  <div class="weibo-main-app">
    ...
    <div class="weibo-frame">
      ...
      <middle-col class="weibo-mid-col" v-ref:middle-col :likes="likes" :current-user="currentUser"></middle-col>
...
<script>
import leftCol from '../at/left-col';
...
export default {
  props: ['likes','currentUser','notification'],
  data () {
    return {
